...
CREATE TABLE `User` (
    ...
    `otpExpiryTime` DATETIME(3) NULL,
    `avatar` VARCHAR(191) NULL DEFAULT 'https://us.123rf.com/450wm/pavelstasevich/pavelstasevich1811/pavelstasevich181101027/112815900-no-image-available-icon-flat-vector.jpg?ver=6',
...
CREATE TABLE `Follow` (
    ...
    PRIMARY KEY (`followedId`, `followingId`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
